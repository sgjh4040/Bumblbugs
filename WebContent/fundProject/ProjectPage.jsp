...
<%
	...
	//test code
	System.out.println(pj_idx);
	//
	ProjectBean pjbean = ProjectDAO.getProject(pj_idx); // bean set
	String pj_u_idx = String.valueOf(pjbean.getPj_u_idx());
	UserBean ubean = ProjectDAO.getMember(pj_u_idx);
	//test code
	System.out.println(pjbean);
	//
					...
					<div class="ProjectIntro_Wrapper">
						<div class="ProjectIntro_Outline">
							...
							<div class="ProjectIntro_OutlineInner">
								...
								<div class="ProjectIntro_Creator">
									<span class="ProjectIntro_Profileimg"> <img
										src="../Bumblbugimg/<%=ubean.getU_img()%>"
										style="width: 23px; height: 23px; border-radius: 50%;">
									</span> <span class="ProjectIntro_CreatorName"> <%=pjbean.getLeader_nm()%>
									</span>
								</div>
							</div>
						</div>
						...
						<div class="ProjectIntro_Main">
							...
							<figure class="ProjectIntro_MainCoverImgFigure">
								...
								<img src="../Bumblbugimg/<%=pjbean.getPj_img()%>">
								<!-- <img class="ProjectIntro_MainCoverImg"
									src="D:/Bumblbug/Bumblbug/img/ProjectIntro_MainCoverImg.jpg"
									alt="프로젝트 커버 img"> -->
							</figure>
						</div>
 ...
 %> <%=goalAmount + '%'%>
							...
							<div class="ProjectIntro_FundingInfo">
								<div class="ProjectIntro_InfoInner">
									...
									%> <%=g_str%>원이 모여야만 결제됩니다.<br> 결제는 <%=pjbean.getPj_end_dt()%>
										에 다함께 진행됩니다.
									</span>
								</div>
							</div>
