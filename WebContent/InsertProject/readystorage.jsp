...
<%
	try {
		...
		if (tp_idx == null) {
			...
			int tp_idx2 = Mgr.insertTemp(tempbean, u_idx);
			...
			boolean flag0 = Mgr.UpdateTempTb(tempbean);

			TempPresentBean presentbean = new TempPresentBean();

			out.println("여기 >" + tp_p_idx1);
...
%>
<script>
	alert("프로젝트가 임시저장 되었습니다.")
	location.href = "../Mypage/Mypage_project.jsp"
