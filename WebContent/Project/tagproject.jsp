...
String searchword = request.getParameter("tag_nm");
		
		ArrayList<ProjectBean> list = MainDAO.getTagProject(searchword);
...
<title>"<%=searchword%>"검색  프로젝트</title>
        ...
        <div class="all_project" >
	   	...
	   	<div class="recommend_project">
            	 <div class="recommend_header">
                		<%=searchword%>검색 결과 프로젝트           
            	 </div>
	            
	             <div class="project_card_section">
	            	<c:set var="list" value="<%=list %>"/>
					<c:forEach var ="pjBean" items="${list}">
