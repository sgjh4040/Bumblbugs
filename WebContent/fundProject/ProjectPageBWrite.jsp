						...
						<div class="ProjectPage_ContentsMain">
							<div class="ProjectPage_MaineInner">
								...
								<div id="tabContent02" class="tapPage">
									<jsp:include page="board/boardWrite.jsp"></jsp:include>
								</div>
							</div>
						</div>
											...
											<div class="Card">
												<div class="RewardCard_CardInner">
													<div class="RewardCard_Header">
														<span class="RewardCard_PledgeAmount">${Presentbean.supmem_cnt}명이
															선택</span> <span class="RewardCard_QuantityLimited"> <span
													...
													<div class="RewardCard_Items">
														<li class="RewardCard_ItemList">선물목록</li>
													</div>
													...
													<button class="Button"
														onclick="location.href='RewardsPage.jsp'">선물 선택하고
														밀어주기</button>
												</div>
											</div>
										</c:forEach>
